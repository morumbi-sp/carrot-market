    ...
    <div className='py-10 px-4'>
      <div className='flex items-center space-x-3'>
        ...
        <div className='flex flex-col '>
          ...
          <span className=' text-sm text-gray-800'>Edit profile &rarr;</span>
        </div>
      </div>
      <div className='flex justify-around py-10'>
        <div className='flex flex-col items-center'>
          <div className='flex aspect-square w-14 items-center justify-center rounded-full bg-orange-400 text-white'>
            <svg
              className='h-6 w-6'
              fill='none'
              stroke='currentColor'
      ...
      <div className='flex space-x-3'>
        ...
        <div className='flex flex-col justify-center'>
          <span className='text-sm font-bold'>니꼬</span>
          <div className='flex'>
            <svg
